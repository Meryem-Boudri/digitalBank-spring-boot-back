...
import ma.enset.digitalbank.entities.*;
...
import ma.enset.digitalbank.mappers.BankAccountMapperImpl;
import ma.enset.digitalbank.repositories.AccountOperationRepository;
import ma.enset.digitalbank.repositories.BankAccountRepository;
import ma.enset.digitalbank.repositories.CustomerAccountRepository;
...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    @Override
    public List<BankAccountDTO> getBankAccountListByCustomer(Long customer_id) {
        List<BankAccountDTO> bankAccountList = bankAccountRepository.findBankAccountByCustomerId(customer_id).stream().map(bankAccount -> {
            if (bankAccount instanceof SavingAccount) {
                SavingAccount savingAccount = (SavingAccount) bankAccount;
                return dtoMapper.fromSavingBankAccount(savingAccount);
            } else {
